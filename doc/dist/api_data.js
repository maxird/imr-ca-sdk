define({ "api": [
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "description": "<p>Standard or Expedited</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
      ...
      "fields": {
        "Error 4xx": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "413",
            "description": "<p>Request Entity Too Large</p>"
          },
          {
            "group": "Error 4xx",
            "type": "json",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "description": "<p>(in header of part1) includes filename (must include <code>.pdf</code> extention)</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "Content-Type",
            "description": "<p>(in header of part1) MIME type of the file.<br> (<span style=\"font-style: italic;\">only </span><code>application/pdf</code><span style=\"font-style: italic;\"> supported</span>)</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "description": "<p>For legacy MOVEit users.  The IMR case id is inferred from the file name.   The <code>filename</code> and MIME type are specified in the first part Content-Disposition and Content-Type headers respectively.  Except for the imrCaseNumber pattern in the file name, this request is handled the same as a normal file upload.</p> <p><span style=\"font-weight:700\">Note on specifying Document Size</span> <br/> Upload requests SHOULD include a filesize header that specifies the precise size in bytes of the file being uploaded.  Additionally, the file size can not exceed 500MB.</p>",
    "group": "Documents",
    "header": {
      "fields": {
        "Header": [
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "Content-Type",
            "description": "<p>(in header of part1) MIME type of the file. (<span style=\"font-style: italic;\">only </span><code>application/pdf</code><span style=\"font-style: italic;\"> supported</span>)</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "delete",
    "url": "apigw/webservices/rest/apigw/events/noarfi/:date",
    "title": "02.Acknowledge Manifest Date",
    "name": "NOARFIAck",
    "description": "<p>Indicate to the system that you have successfully retrieved the NOARFI list for the specified date and to no longer show these records as being available for a manifest download.</p>",
    "group": "NOARFI",
    "header": {
      "fields": {
        "Header": [
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "ManifestDate",
            "description": "<p>(yyyy-MM-dd)<span style=\"font-style: italic\">(sent in path)</span></p>"
          }
        ]
      }
    },
    "examples": [
      {
        ...
        "content": "DELETE /apigw/webservices/rest/apigw/events/noarfi/2016-09-27 HTTP/1.1\nUser-Agent: curl/7.19.7 (x86_64-redhat-linux-gnu)\nHost: imr-ca-sandbox.maxird.com\nAuthorization: Bearer eyJhbGciOiJSUzI1NiJ9..WmQd3b0bo7gntuU4pu4EYr8T4cVzz59z6FTOi3Kx61kpb-XSJsYp8nNFab3ZiKQ6MPmxPXyF7sUFWO4pQlAazoyZvov77_EHx9f4sPlfCWoJ6s0kCvOTT-bTlHV85td5qaWZ-cSB9MrTBLovBYsiezFwOnxZbVLgdzJp8Zw3LaDhKzYs4Xz-PQfhgTyx2Oh1owxqfTRAoYXtBMgB6SEtAPQRI_TOiHm5iZ79sBy_YY_S0w49u1kHCDKxLt9yNfhnytaWDSRpTkWogwsC_5Cdui2oadsxaZQzgY8GG8oewZyYpdLiNDHsQDbVBU3WL3upT0HBJutzCmBWrP-6JPAiSA\nAccept: application/json",
        "type": "json"
      }
    ],
    "success": {
  ...
  {
    "type": "get",
    "url": "apigw/webservices/rest/apigw/events/noarfi/",
    "title": "00.Manifest DateList",
    "name": "NOARFIDateList",
    "description": "<p>Returns a list of (zero or more) dates for which unacknowledged NOARFI manifest exists. The dates reflect the system date when the NOARFI letter was generated. The dates format is ISO 8601 (i.e. yyyy-MM-dd).</p>",
    "group": "NOARFI",
    "header": {
      "fields": {
        "Header": [
    ...
    "examples": [
      {
        "title": "DateList Search",
        "content": "GET /apigw/webservices/rest/apigw/events/noarfi/ HTTP/1.1\nUser-Agent: curl/7.19.7 (x86_64-redhat-linux-gnu)\nHost: imr-ca-sandbox.maxird.com\nAuthorization: Bearer eyJhbGciOiJSUzI1NiJ9..OD-S5raMHug0x8pMO7zHcHwzZuosSWx4cH1ktZ557itofxNUWinQgfvngdSg5cvNYpoEChqwQSz-Vd8GYjkjKrE5E-AK94kTLPE3MfzQ5X4KzRMovChshGVJK-sQCrnZONS77G-_UVXL5fITeWKUZnrarvM1X3kr-O0yMIRaB-DOs_hFK972-hB_zo-QMej0XIrTth-yjl5NwtRXXpKrAjqY-em7EWDL--k1Gd-Q4mj9wCTCxsKnIiElexVTaboz0WSBFxKd43EeCTdRC5bLwBVQvS3USCYBnioRnY79sd3GxELM7Zg8F6zgprlQl1P_lQ_5J8y4jO42qxhei92IlQ",
        "type": "json"
      }
    ],
    "success": {
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "datelist",
            "description": "<p>array of ISO 8601 dates with NOARFIs</p>"
          }
        ]
      },
      "examples": [
  ...
  },
  {
    ...
    "title": "01.Details",
    "name": "NOARFIDetails",
    "description": "<p>Returns the list of NOARFI records for a given date. The date is one of the dates listed in the NOARFI Manifest date list service which has not been acknowledged yet. Results are sent as CSV.  The first row will be a header row with the field names.  To facilitate adoption with legacy users, an optional &quot;<code>legacy</code>&quot; mode is available.  In legacy mode, the fields will retain their original names and an additional 10 filler fields will be appended to each row.</p> <table>   <thead>     <tr>       <th>Default Name</th>       <th>Legacy Name</th>       <th>Type</th>       <th>Comment</th>     </tr>   </thead>   <tbody>     <tr>       <td>claimsExaminerFirstName</td>       <td>C_PARTICIPANT_CONTACT_F_NAME</td>       <td>String</td>       <td></td>     </tr>     <tr>       <td>claimsExaminerLastName</td>       <td>C_PARTICIPANT_CONTACT_L_NAME</td>       <td>String</td>       <td></td>     </tr>     <tr>       <td>claimsExaminerSuffix</td>       <td>C_PARTICIPANT_CONTACT_SUFFIX</td>       <td>String</td>       <td></td>     </tr>     <tr>       <td>injuredWorkerSuffix</td>       <td>IW_SUFFIX</td>       <td>String</td>       <td></td>     </tr>     <tr>       <td>claimsAdministratorAddress1</td>       <td>C_PARTICIPANT_1ST_STREET_ADDRE</td>       <td>String</td>       <td></td>     </tr>     <tr>       <td>claimsAdministratorAddress2</td>       <td>C_PARTICIPANT_2ND_STREET_ADDRE</td>       <td>String</td>       <td></td>     </tr>     <tr>       <td>claimsAdministratorCity</td>       <td>C_PARTICIPANT_CITY</td>       <td>String</td>       <td></td>     </tr>     <tr>       <td>claimsAdministratorState</td>       <td>C_PARTICIPANT_STATE</td>       <td>String</td>       <td></td>     </tr>     <tr>       <td>claimsAdministratorZipCode</td>       <td>C_PARTICIPANT_POSTAL_CODE</td>       <td>String</td>       <td></td>     </tr>     <tr>       <td>injuredWorkerFirstName</td>       <td>IW_F_NAME</td>       <td>String</td>       <td></td>     </tr>     <tr>       <td>injuredWorkerLastName</td>       <td>IW_L_NAME</td>       <td>String</td>       <td></td>     </tr>     <tr>       <td>caAppealNumber</td>       <td>C_CA_APPEAL_NUMBER</td>       <td>String</td>       <td></td>     </tr>     <tr>       <td>caseNumber</td>       <td>C_CASE_NUMBER</td>       <td>String</td>       <td></td>     </tr>     <tr>       <td>systemDateIso</td>       <td>SYSTEM_DATE</td>       <td>String</td>       <td>MM/DD/YYYY</td>     </tr>     <tr>       <td>participantType</td>       <td>PARTICIPANT_TYPE</td>       <td>String</td>       <td></td>     </tr>     <tr>       <td>providerName</td>       <td>PROVIDER</td>       <td>String</td>       <td></td>     </tr>     <tr>       <td>claimsAdministratorCompanyName</td>       <td>C_PARTICIPANT_ORGAN_NAME</td>       <td>String</td>       <td></td>     </tr>     <tr>       <td>claimNumber</td>       <td>C_CLAIMS_NUMBER</td>       <td>String</td>       <td></td>     </tr>     <tr>       <td>priority</td>       <td>PRIORITY_TYPE</td>       <td>String</td>       <td>Standard or Expedited</td>     </tr>     <tr>       <td>dateOfInjury</td>       <td>C_INJURY_DATE</td>       <td>String</td>       <td>MM/DD/YYYY</td>     </tr>     <tr>       <td>dateofURDecision</td>       <td>C_UR_DEC_DATE</td>       <td>String</td>       <td>MM/DD/YYYY</td>     </tr>     <tr>       <td>treatmentRequested</td>       <td>C_TXREQ</td>       <td>String</td>       <td></td>     </tr>     <tr>       <td>receiveDate</td>       <td>C_RCVDATE</td>       <td>String</td>       <td>MM/DD/YYYY</td>     </tr>     <tr>       <td><span style=\"font-style: italic\">Not Sent</span></td>       <td>C_ACKSENTDATE</td>       <td>String</td>       <td></td>     </tr>     <tr>       <td><span style=\"font-style: italic\">Not Sent</span></td>       <td>SEQUENCE_NUMBER</td>       <td>String</td>       <td></td>     </tr>     <tr>       <td><span style=\"font-style: italic\">Not Sent</span></td>       <td>FILENAME</td>       <td>String</td>       <td></td>     </tr>     <tr>       <td><span style=\"font-style: italic\">Not Sent</span></td>       <td>CASECOUNT</td>       <td>String</td>       <td></td>     </tr>     <tr>       <td><span style=\"font-style: italic\">Not Sent</span></td>       <td>ODD_EVEN</td>       <td>String</td>       <td></td>     </tr>     <tr>       <td><span style=\"font-style: italic\">Not Sent</span></td>       <td>DOI_COUNT</td>       <td>String</td>       <td></td>     </tr>     <tr>       <td><span style=\"font-style: italic\">Not Sent</span></td>       <td>C_BARCODE_CASE_NUMBER</td>       <td>String</td>       <td></td>     </tr>     <tr>       <td><span style=\"font-style: italic\">Not Sent</span></td>       <td>C_BARCODE_PART_TYPE</td>       <td>String</td>       <td></td>     </tr>     <tr>       <td><span style=\"font-style: italic\">Not Sent</span></td>       <td>C_BARCODE_DOC_TYPE</td>       <td>String</td>       <td></td>     </tr>     <tr>       <td><span style=\"font-style: italic\">Not Sent</span></td>       <td>C_DOC_TYPE_MR</td>       <td>String</td>       <td></td>     </tr>   </tbody> </table>",
    "group": "NOARFI",
    "header": {
      "fields": {
        "Header": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "Accepts",
            "description": "<p>text/plain (response will be CSV)</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "option",
            "description": "<p>&quot;<code>legacy</code>&quot;<span style=\"font-style: italic\">(optional url parameter to request legacy format)</span></p>"
          }
        ]
      }
    },
    "examples": [
      {
        "title": "NOARFI Detail ",
        "content": "GET /apigw/webservices/rest/apigw/events/noarfi/datelist/2016-09-27 HTTP/1.1\nUser-Agent: curl/7.19.7 (x86_64-redhat-linux-gnu)\nHost: imr-ca-sandbox.maxird.com\nAuthorization: Bearer eyJhbGciOiJSUzI1NiJ9..OD-S5raMHug0x8pMO7zHcHwzZuosSWx4cH1ktZ557itofxNUWinQgfvngdSg5cvNYpoEChqwQSz-Vd8GYjkjKrE5E-AK94kTLPE3MfzQ5X4KzRMovChshGVJK-sQCrnZONS77G-_UVXL5fITeWKUZnrarvM1X3kr-O0yMIRaB-DOs_hFK972-hB_zo-QMej0XIrTth-yjl5NwtRXXpKrAjqY-em7EWDL--k1Gd-Q4mj9wCTCxsKnIiElexVTaboz0WSBFxKd43EeCTdRC5bLwBVQvS3USCYBnioRnY79sd3GxELM7Zg8F6zgprlQl1P_lQ_5J8y4jO42qxhei92IlQ",
        "type": "json"
      }
    ],
    "success": {
